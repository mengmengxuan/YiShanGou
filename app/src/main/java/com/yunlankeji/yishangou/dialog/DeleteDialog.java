...
//                RichText.fromHtml(msgStr.toString()).into(message);
        ...
        positive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onStatusListener != null) {
                    onStatusListener.OnStatus(DeleteDialog.this);
                }
            }
        });
    ...
    public DeleteDialog setCaption(CharSequence str) {
        titleStr = str;
        return this;
    }

    public DeleteDialog setMessage(CharSequence str) {
        msgStr = str;
        return this;
    }
     ...
     * @return
     */
    public DeleteDialog setPositiveButton(CharSequence text, int back_color, int text_color, OnStatusListener l) {
        bYes = true;
        positiveStr = text;
    ...
    public DeleteDialog setNegativeButton(CharSequence text, OnStatusListener l) {
        bNo = true;
        negativeStr = text;
        onStatusListener = l;
        return this;
